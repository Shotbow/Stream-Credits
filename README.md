For live streams, Shotbow uses a playlist of music.  While we would like to properly credit each and every song used at the appropriate points or in order, it is not possible to do so.
